        ...
        <div class="col-sm-3 padding-top">
            <div class="panel panel-primary">
                ...
                <div class="list-group">
                    <a href="{{ base_url() }}" class="list-group-item">Onze topsporters. <span class="pull-right badge">0</span></a>
                    <a href="{{ base_url() }}" class="list-group-item">Deelnemende ploegen. <span class="pull-right badge">0</span></a>
